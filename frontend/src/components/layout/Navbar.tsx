...
export interface NavbarProps {
  cartCount?: number;
  onCartClick?: () => void;
  /** True once the page has scrolled — lifts the main bar with a shadow. */
  scrolled?: boolean;
}
...
export function Navbar({ cartCount = 0, onCartClick, scrolled = false }: NavbarProps) {
  ...
  return (
    <div className="w-full">
      {/* utility bar — warm gray strip, always visible on md+ */}
      <div className={cn('hidden md:block', UTILITY_BG)}>
      ...
      <div
        className={cn(
          'bg-surface',
          'transition-shadow duration-[--duration-base] ease-[--ease-standard]',
          scrolled && 'navbar-main-bar-shadow'
        )}
      >
        <div className={SITE_CONTAINER}>
            ...
            <div className="ml-auto flex shrink-0 items-center gap-2 md:gap-3">
              ...
              <div className="flex items-center gap-0.5 sm:gap-1">
                <div className="hidden items-center sm:flex">
                  {/* TODO: Add notifications if ever needed */}
                ...
                <button
                  ...
                  aria-label="Cart"
                >
                  <ShoppingCart className="size-[1.05rem]" aria-hidden strokeWidth={1.75} />
                  {cartCount > 0 && (
