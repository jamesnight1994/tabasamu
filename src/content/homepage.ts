...
export const HERO = {
  ...
  secondaryCta: { label: 'How it is made', href: '/our-story' },
} as const;
...
export const COLLECTION = {
  ...
  intro:
    'The label never changes. Only the strip along the bottom does — so you learn to find your one by its colour.',
  cta: { label: 'See all six', href: '/shop' },
} as const;
...
export const PROCESS = {
  ...
  /**
   * ⚠ Progressive disclosure. The headline of each step is enough for a
   *   scanner; the detail is behind an accordion for the person who wants it.
   *   Nobody is forced to read a science lesson to buy a drink.
   */
  steps: [
    {
      title: 'Steep',
